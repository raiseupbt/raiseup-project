...
export const meta: MetaFunction = () => {
  return [
    { title: "RaiseUp - Automações com IA para Transformação Digital | Agentes Inteligentes" },
    { name: "description", content: "RaiseUp oferece automações com IA humanizada para transformação digital. Agentes conversacionais, mídias sociais e produtividade. Libere sua equipe de tarefas repetitivas." },
    { name: "keywords", content: "automação com IA, transformação digital, agentes conversacionais, chatbot, automação redes sociais, produtividade empresarial, IA humanizada, inteligência artificial" },
    { property: "og:title", content: "RaiseUp - Automações com IA para Transformação Digital" },
    { property: "og:description", content: "Transforme seu negócio com automações inteligentes que preservam o toque humano. Agentes para atendimento, redes sociais e produtividade." },
