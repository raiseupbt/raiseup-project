...
export const meta: MetaFunction = () => {
  return {
    ...
    description: "Agentes de Mídias Sociais da RaiseUp: Gestão automatizada de redes sociais com IA. Postagens inteligentes, respostas automáticas e análise de sentimento."
  };
};
